...
class SupabaseAdapter:
    """Thin adapter that implements repository port by delegating to
    the clean repository instances. Keeps signatures stable
    for the application layer.
    
    This adapter wraps both legacy and new repository interfaces.
    """

    def __init__(self):
        self._interaction_repo = SupabaseInteractionRepository()
        self._session_repo = SupabaseSessionRepository()
        self._user_repo = SupabaseUserRepository()
        self._embedding_repo = SupabaseEmbeddingRepository()
    ...
    def get_supabase_client(self):
        return self._interaction_repo.client
