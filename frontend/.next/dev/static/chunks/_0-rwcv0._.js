...
;
;
function TTSControls({ text, isSpeaking, voiceGender, onSpeak, onStop, onGenderChange }) {
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                        ...
                        className: `flex items-center gap-1 px-2.5 py-1.5 text-xs transition-all duration-200 ${voiceGender === "female" ? "bg-pink-500/30 text-pink-300" : "text-slate-500 hover:text-slate-300"}`,
                        title: "Female voice",
                        children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                        ...
                        className: `flex items-center gap-1 px-2.5 py-1.5 text-xs transition-all duration-200 ${voiceGender === "male" ? "bg-blue-500/30 text-blue-300" : "text-slate-500 hover:text-slate-300"}`,
                        title: "Male voice",
                        children: [
...
function useTTS() {
    ...
    const [voiceGender, setVoiceGender] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("female");
    ...
    const getVoice = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useTTS.useCallback[getVoice]": (gender)=>{
            ...
            // Fallback: pick by index (even = female, odd = male)
    ...
    const speak = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useTTS.useCallback[speak]": (text)=>{
            ...
            // Clean text — remove markdown bold/italic markers
            const cleanText = text.replace(/\*\*(.*?)\*\*/g, "$1").replace(/\*(.*?)\*/g, "$1").replace(/#{1,6}\s/g, "").replace(/🎵|💡|🌬️|📦|🫁|✅|🗂️|☕|🚪|🤝|📉|🔍|🏙️|💬|🌐|📱|💪|✍️|🤲/g, "").trim();
            const utterance = new SpeechSynthesisUtterance(cleanText);
            utteranceRef.current = utterance;
            // Wait for voices to load if needed
            const setVoiceAndSpeak = {
                "useTTS.useCallback[speak].setVoiceAndSpeak": ()=>{
                    ...
                    utterance.volume = 1;
                    utterance.onstart = ({
                        "useTTS.useCallback[speak].setVoiceAndSpeak": ()=>setIsSpeaking(true)
                    })["useTTS.useCallback[speak].setVoiceAndSpeak"];
                    utterance.onend = ({
                        "useTTS.useCallback[speak].setVoiceAndSpeak": ()=>setIsSpeaking(false)
                    })["useTTS.useCallback[speak].setVoiceAndSpeak"];
                    utterance.onerror = ({
                        "useTTS.useCallback[speak].setVoiceAndSpeak": ()=>setIsSpeaking(false)
                    })["useTTS.useCallback[speak].setVoiceAndSpeak"];
...
_s(useTTS, "//MfzOiVDPnyOGpl1SoOD+YoSBQ=");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
"[project]/components/chat/MessageBubble.tsx [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {

const e = new Error("Could not parse module '[project]/components/chat/MessageBubble.tsx'\n\nReturn statement is not allowed here");
...
//# sourceMappingURL=_0-rwcv0._.js.map